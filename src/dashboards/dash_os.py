...
def get_ordem_servico():
    sql_url = "https://raw.githubusercontent.com/pelais/mysql-powerbi/master/querys/ordem-servico/q-ordem-servico.sql"
    query = read_sql_from_github(sql_url)

    return execute_firebird_query(query)

def get_condpagto_os():
    sql_url = "https://raw.githubusercontent.com/pelais/mysql-powerbi/master/querys/ordem-servico/q-condpgto-os.sql"
    query = read_sql_from_github(sql_url)

    return execute_firebird_query(query)

def get_itens_os():
    sql_url = "https://raw.githubusercontent.com/pelais/mysql-powerbi/master/querys/ordem-servico/q-itens-os.sql"
    query = read_sql_from_github(sql_url)

    return execute_firebird_query(query)

def get_centro_custo():
    sql_url = "https://raw.githubusercontent.com/pelais/mysql-powerbi/master/querys/ordem-servico/q-centro-custo.sql"
    query = read_sql_from_github(sql_url)
